...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, obstacle_sprites, damage_player, trigger_death_particles, add_exp):
        ...
        # sounds
        self.death_sound = pygame.mixer.Sound(os.path.join(dir_path, 'audio', 'death.wav'))
        self.hit_sound = pygame.mixer.Sound(os.path.join(dir_path, 'audio', 'hit.wav'))
    ...
    def actions(self, player):
        if self.status == 'attack':
            ...
            self.damage_player(self.attact_damage, self.attack_type)
